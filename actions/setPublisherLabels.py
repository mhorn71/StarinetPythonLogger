...
def control(buffer0, buffer1, buffer2, buffer3, buffer4, buffer5, buffer6):
    ...
    try:
        ...
        config.set('publisherlabels', 'channel0', buffer1)  # update
        config.set('publisherlabels', 'channel1', buffer2)  # update
        config.set('publisherlabels', 'channel2', buffer3)  # update
        config.set('publisherlabels', 'channel3', buffer4)  # update
        config.set('publisherlabels', 'channel4', buffer5)  # update
        config.set('publisherlabels', 'channel5', buffer6)  # update
